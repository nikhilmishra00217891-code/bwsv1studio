...
import { Moon, Sun, Heart, Gamepad2, Palette, Shield } from "lucide-react"
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="outline" size="icon">
          <Sun className="h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0 [.proudshe_&]:-rotate-90 [.proudshe_&]:scale-0 [.retrogamer_&]:-rotate-90 [.retrogamer_&]:scale-0 [.custom_&]:-rotate-90 [.custom_&]:scale-0 [.yinyang_&]:-rotate-90 [.yinyang_&]:scale-0" />
          ...
          <Shield className="absolute h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-all [.yinyang_&]:rotate-0 [.yinyang_&]:scale-100" />
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuItem onClick={() => setTheme("retrogamer")}>
         ...
         <DropdownMenuItem onClick={() => setTheme("yinyang")}>

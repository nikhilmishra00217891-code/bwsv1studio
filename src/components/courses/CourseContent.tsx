...
import { listenForLiveChatMessages, sendLiveChatMessage } from "@/lib/data";
                            ...
                            <div key={msg.id} className="flex items-start gap-2 text-sm">
                                ...
                                <div>
                                    <div className="flex items-baseline gap-2">
                                        ...
                                        <p className="text-xs text-muted-foreground">{formatDistanceToNow(msg.timestamp.toDate(), { addSuffix: true })}</p>
                                    </div>
                                    <p>{msg.text}</p>
                                </div>
                            </div>

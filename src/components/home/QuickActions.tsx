...
const actions: ActionItem[] = [
    { title: "Ask BWS Buddy", icon: Bot, onClick: openAiMentor, color: "bg-blue-500/20 text-blue-500" },
    ...
    { title: "Mock Tests", icon: Brain, href: "#", color: "bg-yellow-500/20 text-yellow-500" },
];

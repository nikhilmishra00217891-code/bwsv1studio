...
import { LoaderCircle, Hash, MessageSquare, Users, Settings, Plus, Send, BrainCircuit, Bot, Menu, X } from 'lucide-react';
...
const ChannelPanel = ({ className, onClose }: { className?: string, onClose?: () => void }) => {
...
const MemberList = ({ className, onClose }: { className?: string, onClose?: () => void }) => {
    const { user } = useAuth();
    return (
    ...
    return (
        <TooltipProvider>
            <div className="flex h-screen bg-background text-foreground">
                ...
                <ChannelPanel className="hidden md:flex" />

                {/* Main Content (Chat Area) */}
                <div className="flex-1 flex flex-col">
                    <header className="p-4 border-b shadow-sm h-16 flex items-center justify-between">
                         <Button variant="ghost" size="icon" className="md:hidden" onClick={() => setIsChannelPanelOpen(true)}>
                            <Menu/>
                        </Button>
                        ...
                        <p className="text-sm text-muted-foreground hidden lg:block">The general chat channel for our Parivaar.</p>
                        <Button variant="ghost" size="icon" className="md:hidden" onClick={() => setIsMemberListOpen(true)}>
                            <Users />
                        </Button>
                    </header>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="bg-card p-3 rounded-lg rounded-tl-none mt-1 max-w-md">
                 ...
                 <MemberList className="hidden md:flex" />
            </div>
        </TooltipProvider>
    );
};
